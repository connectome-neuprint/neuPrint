...
//
//        Neuron neuron1 = new Neuron(85L, x.getStatus(), x.getName(), x.getType(), x.getSize(), x.getRois(), x.getSoma());
//        Neuron neuron2 = new Neuron(85L, y.getStatus(), y.getName(), y.getType(), y.getSize(), y.getRois(), y.getSoma());
//        Neuron neuron3 = new Neuron(85L, z.getStatus(), z.getName(), z.getType(), z.getSize(), z.getRois(), z.getSoma());
//
//        //reflexive
